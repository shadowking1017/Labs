...
// Make the query:
$q = "SELECT users.username AS name, messages.body AS body, messages.subject AS sub  FROM messages INNER JOIN users ON messages.user_id = users.user_id WHERE messages.user_id = 1";
